class UniverseVm {
  UniverseVm({required this.moviewName, this.documentId});

  final String moviewName;
  final String? documentId;

  UniverseVm copyWith({String? content, bool? isCompleted}) {
  ...
  @override
  String toString() =>
      'TodoModel(moviewName: $moviewName,   documentId: $documentId)';

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;

    return other is UniverseVm &&
        other.moviewName == moviewName &&
